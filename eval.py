...
def compute_it_sim(args, clip_model):
    # load predicted text
    with open(os.path.join(args.pred_text_path), 'r') as f:
        pred_text = f.readlines()[:args.num_samples]
        f.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_text_path", default='generated image caption', type=str)
    parser.add_argument("--tgt_text_path",  default='target caption', type=str)
